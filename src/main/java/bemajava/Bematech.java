...
public class Bematech {
    ...
    public static native int NomeiaTotalizadorNaoSujeitoIcmsCV0909(int indice, String totalizador, String situacao);
    ...
    public static native int TerminaFechamentoCupomCV0909(String mensagem, int imprimeAdicional, int guilhotina);
    ...
    public static native int DataHoraReducao(String cData, String cHora);
    ...
    public static native int EfetuaRecebimentoNaoFiscalCV0909(String indiceTotalizador,
                                                              String valorRecebimento);
    ...
    public static native int VerificaZPendente(String cStatus);
    ...
    public static native int GeraRegistrosCAT52MFD(String cArquivo, String cData);
    ...
    //public static native int ImprimeTextoLivre	(String filename);
